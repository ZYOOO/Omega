...
- TS + React SPA 已包含门户首页与 Workboard 功能页。
- 首页参考飞书工作台门户结构：顶部产品导航、左侧应用入口、中部应用宫格与模板推荐、右侧信息卡片，但使用 Omega 自己的文案与信息架构。
- Workboard 功能页继续承载 Requirement / Item / Pipeline / Agent / GitHub 交付闭环。
